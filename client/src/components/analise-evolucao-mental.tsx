...
export default function AnaliseEvolucaoMental() {
  ...
  return (
    <section className="mb-6">
      {/* Card externo com bordas completamente arredondadas e altura muito maior */}
      <Card className="border-border rounded-full p-12" style={{ backgroundColor: 'rgba(0, 5, 21, 0.73)' }}>
